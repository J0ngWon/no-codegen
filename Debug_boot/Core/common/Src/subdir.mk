...
clean-Core-2f-common-2f-Src:
	-$(RM) ./Core/common/Src/clock.cyclo ./Core/common/Src/clock.d ./Core/common/Src/clock.o ./Core/common/Src/clock.su ./Core/common/Src/crashlog.cyclo ./Core/common/Src/crashlog.d ./Core/common/Src/crashlog.o ./Core/common/Src/crashlog.su ./Core/common/Src/eeplog.cyclo ./Core/common/Src/eeplog.d ./Core/common/Src/eeplog.o ./Core/common/Src/eeplog.su ./Core/common/Src/eepstate.cyclo ./Core/common/Src/eepstate.d ./Core/common/Src/eepstate.o ./Core/common/Src/eepstate.su ./Core/common/Src/gpio.cyclo ./Core/common/Src/gpio.d ./Core/common/Src/gpio.o ./Core/common/Src/gpio.su ./Core/common/Src/i2c1.cyclo ./Core/common/Src/i2c1.d ./Core/common/Src/i2c1.o ./Core/common/Src/i2c1.su ./Core/common/Src/lcd2.cyclo ./Core/common/Src/lcd2.d ./Core/common/Src/lcd2.o ./Core/common/Src/lcd2.su ./Core/common/Src/stm32f4xx_it.cyclo ./Core/common/Src/stm32f4xx_it.d ./Core/common/Src/stm32f4xx_it.o ./Core/common/Src/stm32f4xx_it.su ./Core/common/Src/syscalls.cyclo ./Core/common/Src/syscalls.d ./Core/common/Src/syscalls.o ./Core/common/Src/syscalls.su ./Core/common/Src/sysmem.cyclo ./Core/common/Src/sysmem.d ./Core/common/Src/sysmem.o ./Core/common/Src/sysmem.su ./Core/common/Src/system_stm32f4xx.cyclo ./Core/common/Src/system_stm32f4xx.d ./Core/common/Src/system_stm32f4xx.o ./Core/common/Src/system_stm32f4xx.su ./Core/common/Src/timbase.cyclo ./Core/common/Src/timbase.d ./Core/common/Src/timbase.o ./Core/common/Src/timbase.su ./Core/common/Src/uart6.cyclo ./Core/common/Src/uart6.d ./Core/common/Src/uart6.o ./Core/common/Src/uart6.su
